                    ...
                    <table class="table table-striped table-bordered shadow-sm">
                        ...
                        <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                ...
                                <td class="align-middle mw-30"><?php echo e($member->firstname . " " . $member->lastname); ?></td>
                                <td class="align-middle mw-25"><?php echo e($member->rep_subject); ?></td>
                                <td class="align-middle mw-20"><a
                                        href="<?php echo e('mailto:' . $member->email); ?>"> <?php echo e($member->email); ?></a></td>

                                <?php if($member->show): ?>
                                    <td class="align-middle"><input type="checkbox" class="show" id="<?php echo e($member->id); ?>"
                                                                    checked></td>
                                <?php else: ?>
                                    <td class="align-middle"><input type="checkbox" class="show" id="<?php echo e($member->id); ?>">
                                    </td>
...
<?php echo $__env->make('partials/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/developer/PhpstormProjects/AlbTask2/src/resources/views/admin/list.blade.php ENDPATH**/ ?>